...
/// <summary>
/// Settings for <see cref="TpLinkClient.CreateAsync(TpLinkOptions, CancellationToken)"/>. Bind it from a
/// configuration section named <see cref="SectionName"/> (appsettings.json, user-secrets or
/// <c>TpLink__Login</c>-style environment variables), then call <see cref="ApplyEnvironmentFallback"/> to honour
/// the original <c>tplink_powerline_*</c> variables.
/// </summary>
public class TpLinkOptions
{
    ...
    [MemberNotNull(nameof(Login), nameof(Password))]
