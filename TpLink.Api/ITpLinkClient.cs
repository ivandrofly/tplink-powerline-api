...
namespace TpLink.Api
{
    ...
    public interface ITpLinkClient : IDisposable
    {
        ...
        Task<TpLinkResponse<Guest2G>> GetGuest2GAsync(CancellationToken cancellationToken = default);

        /// <summary>Guest network settings for the 5 GHz band.</summary>
        Task<TpLinkResponse<Guest5G>> GetGuest5GAsync(CancellationToken cancellationToken = default);
